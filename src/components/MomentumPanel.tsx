import type { AdvantageBreakdown, LastAdvantage } from "../types.js";
...
function renderMomentumRow(label: string, value: number, extraClass = ""): string {
  return `
...
function renderMomentumSide(title: string, breakdown: AdvantageBreakdown, tone: "player" | "enemy"): string {
...
export function renderMomentumPanel({
  playerBreakdown,
  enemyBreakdown,
  lastAdvantage
}: {
